...
<body>
    ...
    <hr />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        	...
        	<tr>
        		<td width="100px"> 
                    <asp:Button ID="btnNew" runat="server" Text=" 新 增 " onclick="btnNew_Click" /></td><td></td>
        	</tr>
        	<tr>
        		<td>&nbsp;</td><td><td>
        	</tr>
        	<tr>
        		<td>
                    <asp:Button ID="btnEdit" runat="server" Text=" 修 改 " onclick="btnEdit_Click" /></td><td><td>
        	</tr>
        	<tr>
        		<td>&nbsp;</td><td></td>
        	</tr>
        	<tr>
        		<td>
                    <asp:Button ID="btnDel" runat="server" Text=" 删 除 " onclick="btnDel_Click" /></td><td><td>
        	</tr>
        	<tr>
        		<td>&nbsp;</td><td><td>
        	</tr>
