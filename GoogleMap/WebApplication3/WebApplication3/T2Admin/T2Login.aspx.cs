...
{
    public partial class T2Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "select * from T2_MapUser where ID=1";
                ...
                {
                    Session["T2UserName"] = txtUserName.Text.Trim();
                    Response.Redirect("T2List.aspx");
                }
                else
                {
