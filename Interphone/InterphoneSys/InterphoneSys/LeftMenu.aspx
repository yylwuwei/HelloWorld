      ...
      width=150 border=0>
        <TR height=20>
          ...
          <TD><A class=menuChild 
            ...
            target=main>监控地图</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="AlarmInfo.aspx" 
            target=main>系统告警</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="BSInfo.aspx" 
            target=main>基站信息</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="AlarmSet.aspx" 
            target=main>告警设置</A></TD></TR>
       <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="#" 
            target=main>录音设置</A></TD></TR>
                   <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="#" 
            target=main>日志记录</A></TD></TR>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background=images/menu_bt.jpg><A 
            ...
            href="javascript:void(0);">基站管理</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background=images/menu_bt.jpg><A 
            ...
            href="javascript:void(0);">数据查询</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background=images/menu_bt.jpg><A 
            ...
            href="javascript:void(0);">系统帮助</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
